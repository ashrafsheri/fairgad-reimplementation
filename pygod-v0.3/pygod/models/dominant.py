...
class DOMINANT(BaseDetector):
    ...
    def _use_neighbor_loader(self):
        return WITH_PYG_LIB or WITH_TORCH_SPARSE

    def _prepare_full_batch(self, G):
        G.node_idx = torch.arange(G.x.shape[0])
        G.batch_size = G.x.shape[0]
